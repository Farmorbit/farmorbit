      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+$600 from last month</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">1.5 hrs</div>
            <p className="text-xs text-muted-foreground">-0.5 hrs from last month</p>
          </CardContent>
        </Card>
      </div>
          ...
          <TabsContent value="listings" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your equipment available for rent</CardDescription>
              </CardHeader>
              <CardContent>
                {myListings.length > 0 ? (
                  <div className="space-y-4">
                    {myListings.map((listing) => (
                      <div key={listing.id} className="flex items-center gap-4 rounded-lg border p-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">${listing.price}/day</p>
                          <div className="mt-1 flex items-center gap-4 text-xs text-muted-foreground">
                            ...
                            <span className="flex items-center gap-1">
                              <DollarSign className="h-3 w-3" />${listing.revenue} revenue
                            </span>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">List your equipment to start earning</p>
                  </div>
                )}
              </CardContent>
